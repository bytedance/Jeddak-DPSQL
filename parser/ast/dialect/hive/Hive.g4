...
whereClause
    : WHERE columnExpr                                                              # WhereExpr
    | WHERE NOT? EXISTS selectStmtWithParens                                        # WhereExistsQuery
    ;
groupByClause
...
clusterByClause: CLUSTER BY columnExprList;
distributeByClause: DISTRIBUTE BY columnExprList;
sortByClause: SORT BY orderExprList;
...
orderExpr: columnExpr (ASC | ASCENDING | DESCENDING | DESC)? (NULLS (FIRST | LAST))? (COLLATE STRING_LITERAL)?;
...
columnExpr
    ...
    | BINARY LPAREN columnExpr RPAREN                                                     # ColumnExprBinaryCast
    ...
    | columnExpr IS NOT? (JSON_TRUE | JSON_FALSE)                                         # ColumnExprIsTrue
